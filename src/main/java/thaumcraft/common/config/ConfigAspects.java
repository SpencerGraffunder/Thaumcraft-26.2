...
public class ConfigAspects {
    ...
    public static void init() {
        ...
        registerThaumcraftAspectAddendum();
    ...
    // -----------------------------------------------------------------
    // Generated aspect-coverage addendum (26.2 audit): every registered
    // item/block yields essence when distilled. Avoids silent empty
    // crucible outputs for crafting ingredients.
    private static void registerThaumcraftAspectAddendum() {
        ...
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.CRIMSON_BOOTS.get()), new AspectList().add(Aspect.MAN, 1).add(Aspect.DARKNESS, 3).add(Aspect.ELDRITCH, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.CRIMSON_PLATE_CHEST.get()), new AspectList().add(Aspect.METAL, 2));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.CRIMSON_PLATE_HELM.get()), new AspectList().add(Aspect.METAL, 2));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.CRIMSON_PLATE_LEGS.get()), new AspectList().add(Aspect.METAL, 2));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.CRIMSON_PRAETOR_CHEST.get()), new AspectList().add(Aspect.MAN, 1).add(Aspect.DARKNESS, 3).add(Aspect.ELDRITCH, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.CRIMSON_PRAETOR_HELM.get()), new AspectList().add(Aspect.MAN, 1).add(Aspect.DARKNESS, 3).add(Aspect.ELDRITCH, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.CRIMSON_PRAETOR_LEGS.get()), new AspectList().add(Aspect.MAN, 1).add(Aspect.DARKNESS, 3).add(Aspect.ELDRITCH, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.CRIMSON_RITES.get()), new AspectList().add(Aspect.MAN, 1).add(Aspect.DARKNESS, 3).add(Aspect.ELDRITCH, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.CRIMSON_ROBE_CHEST.get()), new AspectList().add(Aspect.MAN, 1).add(Aspect.EARTH, 1).add(Aspect.CRAFT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.CRIMSON_ROBE_HELM.get()), new AspectList().add(Aspect.MAN, 1).add(Aspect.EARTH, 1).add(Aspect.CRAFT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.CRIMSON_ROBE_LEGS.get()), new AspectList().add(Aspect.MAN, 1).add(Aspect.EARTH, 1).add(Aspect.CRAFT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.CRYSTAL_ESSENCE.get()), new AspectList().add(Aspect.CRYSTAL, 8).add(Aspect.AURA, 8));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.ELEMENTAL_AXE.get()), new AspectList().add(Aspect.TOOL, 3));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.ELEMENTAL_HOE.get()), new AspectList().add(Aspect.TOOL, 3));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.ELEMENTAL_PICK.get()), new AspectList().add(Aspect.TOOL, 3));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.ELEMENTAL_SHOVEL.get()), new AspectList().add(Aspect.TOOL, 3));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.ELEMENTAL_SWORD.get()), new AspectList().add(Aspect.TOOL, 3));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.FLUX_CRYSTAL.get()), new AspectList().add(Aspect.FLUX, 2).add(Aspect.CRYSTAL, 2));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.GOLEM_PLACER.get()), new AspectList().add(Aspect.MECHANISM, 2).add(Aspect.METAL, 1).add(Aspect.TOOL, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.GRAPPLE_GUN.get()), new AspectList().add(Aspect.MOTION, 4).add(Aspect.MECHANISM, 2).add(Aspect.METAL, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.GRAPPLE_GUN_SPOOL.get()), new AspectList().add(Aspect.MOTION, 4).add(Aspect.MECHANISM, 2).add(Aspect.METAL, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.GRAPPLE_GUN_TIP.get()), new AspectList().add(Aspect.MOTION, 4).add(Aspect.MECHANISM, 2).add(Aspect.METAL, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.HAND_MIRROR.get()), new AspectList().add(Aspect.VOID, 6).add(Aspect.WATER, 2));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.LABEL_BLANK.get()), new AspectList().add(Aspect.SENSES, 1).add(Aspect.CRAFT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.LABEL_FILLED.get()), new AspectList().add(Aspect.SENSES, 1).add(Aspect.CRAFT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.MIND.get()), new AspectList().add(Aspect.MIND, 4));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.NITOR.get()), new AspectList().add(Aspect.LIGHT, 3).add(Aspect.FIRE, 2));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.PECH_WAND.get()), new AspectList().add(Aspect.MECHANISM, 3).add(Aspect.MAGIC, 4));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.RESONATOR.get()), new AspectList().add(Aspect.ENERGY, 4).add(Aspect.SENSES, 2));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.SALISITE.get()), new AspectList().add(Aspect.ALCHEMY, 2).add(Aspect.CRYSTAL, 2));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.SANITY_CHECKER.get()), new AspectList().add(Aspect.MIND, 4).add(Aspect.SENSES, 2));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.SEAL_BLANK.get()), new AspectList().add(Aspect.CRAFT, 1).add(Aspect.FLUX, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.SEAL_BREAKER.get()), new AspectList().add(Aspect.CRAFT, 1).add(Aspect.FLUX, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.SEAL_BREAKER_ADVANCED.get()), new AspectList().add(Aspect.CRAFT, 1).add(Aspect.FLUX, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.SEAL_BUTCHER.get()), new AspectList().add(Aspect.CRAFT, 1).add(Aspect.FLUX, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.SEAL_EMPTY.get()), new AspectList().add(Aspect.CRAFT, 1).add(Aspect.FLUX, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.SEAL_FILL.get()), new AspectList().add(Aspect.CRAFT, 1).add(Aspect.FLUX, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.SEAL_GUARD.get()), new AspectList().add(Aspect.CRAFT, 1).add(Aspect.FLUX, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.SEAL_HARVEST.get()), new AspectList().add(Aspect.CRAFT, 1).add(Aspect.FLUX, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.SEAL_LUMBER.get()), new AspectList().add(Aspect.CRAFT, 1).add(Aspect.FLUX, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.SEAL_PICKUP.get()), new AspectList().add(Aspect.CRAFT, 1).add(Aspect.FLUX, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.SEAL_PROVIDE.get()), new AspectList().add(Aspect.CRAFT, 1).add(Aspect.FLUX, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.SEAL_STOCK.get()), new AspectList().add(Aspect.CRAFT, 1).add(Aspect.FLUX, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.SEAL_USE.get()), new AspectList().add(Aspect.CRAFT, 1).add(Aspect.FLUX, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.TAINT_SLIME.get()), new AspectList().add(Aspect.FLUX, 5).add(Aspect.ENTROPY, 3));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.TAINT_TENDRIL.get()), new AspectList().add(Aspect.FLUX, 5).add(Aspect.ENTROPY, 3));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.TURRET_PLACER_ADVANCED.get()), new AspectList().add(Aspect.MECHANISM, 3).add(Aspect.METAL, 1).add(Aspect.TOOL, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.TURRET_PLACER_BASIC.get()), new AspectList().add(Aspect.MECHANISM, 3).add(Aspect.METAL, 1).add(Aspect.TOOL, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.TURRET_PLACER_BORE.get()), new AspectList().add(Aspect.MECHANISM, 3).add(Aspect.METAL, 1).add(Aspect.TOOL, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.VOID_ROBE_CHEST.get()), new AspectList().add(Aspect.MAN, 1).add(Aspect.EARTH, 1).add(Aspect.CRAFT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.VOID_ROBE_HELM.get()), new AspectList().add(Aspect.MAN, 1).add(Aspect.EARTH, 1).add(Aspect.CRAFT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.VOID_ROBE_LEGS.get()), new AspectList().add(Aspect.MAN, 1).add(Aspect.EARTH, 1).add(Aspect.CRAFT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.ALCHEMICAL_BRASS_ADVANCED_BLOCK.get()), new AspectList().add(Aspect.METAL, 2));
        ...
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.ARCANE_PILLAR.get()), new AspectList().add(Aspect.MAGIC, 1).add(Aspect.EARTH, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.ARCANE_STONE_BRICK_SLAB.get()), new AspectList().add(Aspect.MAGIC, 1).add(Aspect.EARTH, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.ARCANE_STONE_BRICK_STAIRS.get()), new AspectList().add(Aspect.MAGIC, 1).add(Aspect.EARTH, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.ARCANE_STONE_SLAB.get()), new AspectList().add(Aspect.MAGIC, 1).add(Aspect.EARTH, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.ARCANE_STONE_STAIRS.get()), new AspectList().add(Aspect.MAGIC, 1).add(Aspect.EARTH, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.ARCANE_WORKBENCH_CHARGER.get()), new AspectList().add(Aspect.MAGIC, 1).add(Aspect.EARTH, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.CANDLE_BLACK.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.CANDLE_BLUE.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.CANDLE_BROWN.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.CANDLE_CYAN.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.CANDLE_GRAY.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.CANDLE_GREEN.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.CANDLE_LIGHT_BLUE.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.CANDLE_LIGHT_GRAY.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.CANDLE_LIME.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.CANDLE_MAGENTA.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.CANDLE_ORANGE.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.CANDLE_PINK.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.CANDLE_PURPLE.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.CANDLE_RED.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.CANDLE_WHITE.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.CANDLE_YELLOW.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.DEEPSLATE_AMBER_ORE.get()), new AspectList().add(Aspect.CRYSTAL, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.DEEPSLATE_CINNABAR_ORE.get()), new AspectList().add(Aspect.METAL, 1).add(Aspect.EARTH, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.DEEPSLATE_QUARTZ_ORE.get()), new AspectList().add(Aspect.METAL, 1).add(Aspect.EARTH, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.ELDRITCH_PILLAR.get()), new AspectList().add(Aspect.EARTH, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.FLESH_BLOCK.get()), new AspectList().add(Aspect.EARTH, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.GREATWOOD_PLANKS.get()), new AspectList().add(Aspect.EARTH, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.GREATWOOD_SLAB.get()), new AspectList().add(Aspect.EARTH, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.GREATWOOD_STAIRS.get()), new AspectList().add(Aspect.EARTH, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.NITOR_BLACK.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.NITOR_BLUE.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.NITOR_BROWN.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.NITOR_CYAN.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.NITOR_GRAY.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.NITOR_GREEN.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.NITOR_LIGHT_BLUE.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.NITOR_LIGHT_GRAY.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.NITOR_LIME.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.NITOR_MAGENTA.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.NITOR_ORANGE.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.NITOR_PINK.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.NITOR_PURPLE.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.NITOR_RED.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.NITOR_WHITE.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.NITOR_YELLOW.get()), new AspectList().add(Aspect.FIRE, 2).add(Aspect.LIGHT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.PAVING_STONE_BARRIER.get()), new AspectList().add(Aspect.EARTH, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.PAVING_STONE_TRAVEL.get()), new AspectList().add(Aspect.EARTH, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.REDSTONE_RELAY.get()), new AspectList().add(Aspect.EARTH, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.SILVERWOOD_PLANKS.get()), new AspectList().add(Aspect.EARTH, 1));
        ...
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.BARRIER.get()), new AspectList().add(Aspect.PROTECT, 3));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.BRAIN_BOX.get()), new AspectList().add(Aspect.MIND, 2).add(Aspect.DEATH, 1).add(Aspect.SENSES, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.CONDENSER.get()), new AspectList().add(Aspect.MECHANISM, 3).add(Aspect.ENERGY, 2));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.CONDENSER_LATTICE.get()), new AspectList().add(Aspect.MECHANISM, 2).add(Aspect.METAL, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.DIOPTRA.get()), new AspectList().add(Aspect.SENSES, 4).add(Aspect.MAGIC, 2));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.EFFECT_GLIMMER.get()), new AspectList().add(Aspect.AURA, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.EFFECT_SAP.get()), new AspectList().add(Aspect.WATER, 1).add(Aspect.PLANT, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.EFFECT_SHOCK.get()), new AspectList().add(Aspect.ENERGY, 3).add(Aspect.AIR, 2));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.ESSENTIA_INPUT.get()), new AspectList().add(Aspect.MECHANISM, 2));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.ESSENTIA_OUTPUT.get()), new AspectList().add(Aspect.MECHANISM, 2));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.ESSENTIA_RESERVOIR.get()), new AspectList().add(Aspect.MECHANISM, 2).add(Aspect.VOID, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.EVERFULL_URN.get()), new AspectList().add(Aspect.VOID, 4).add(Aspect.WATER, 2));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.FLUX_GOO.get()), new AspectList().add(Aspect.FLUX, 4).add(Aspect.ENTROPY, 2));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.FLUX_SCRUBBER.get()), new AspectList().add(Aspect.FLUX, 4).add(Aspect.MECHANISM, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.FOCAL_MANIPULATOR.get()), new AspectList().add(Aspect.TOOL, 3).add(Aspect.MECHANISM, 2));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.FORTRESS_CHEST.get()), new AspectList().add(Aspect.METAL, 1).add(Aspect.PROTECT, 2).add(Aspect.MAN, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.FORTRESS_HELM.get()), new AspectList().add(Aspect.METAL, 1).add(Aspect.PROTECT, 2).add(Aspect.MAN, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.FORTRESS_LEGS.get()), new AspectList().add(Aspect.METAL, 1).add(Aspect.PROTECT, 2).add(Aspect.MAN, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.GOLEM_BELL.get()), new AspectList().add(Aspect.MECHANISM, 2).add(Aspect.METAL, 1).add(Aspect.SENSES, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.GOLEM_BUILDER.get()), new AspectList().add(Aspect.MECHANISM, 3).add(Aspect.METAL, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.GOLEM_MODULE_AGGRESSION.get()), new AspectList().add(Aspect.MECHANISM, 2).add(Aspect.BEAST, 1).add(Aspect.MOTION, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.GOLEM_MODULE_VISION.get()), new AspectList().add(Aspect.MECHANISM, 2).add(Aspect.SENSES, 2));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.GRASS_AMBIENT.get()), new AspectList().add(Aspect.PLANT, 2).add(Aspect.AURA, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.HOLE.get()), new AspectList().add(Aspect.ENTROPY, 3));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.INFERNAL_FURNACE.get()), new AspectList().add(Aspect.FIRE, 5).add(Aspect.MECHANISM, 3));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.INLAY.get()), new AspectList().add(Aspect.METAL, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.LAMP_ARCANE.get()), new AspectList().add(Aspect.LIGHT, 4).add(Aspect.AURA, 3));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.LAMP_FERTILITY.get()), new AspectList().add(Aspect.LIGHT, 2).add(Aspect.LIFE, 3));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.LAMP_GROWTH.get()), new AspectList().add(Aspect.LIGHT, 2).add(Aspect.PLANT, 3));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.LEVITATOR.get()), new AspectList().add(Aspect.AIR, 3).add(Aspect.MOTION, 3));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.MATRIX_COST.get()), new AspectList().add(Aspect.MECHANISM, 2).add(Aspect.AURA, 2));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.MATRIX_SPEED.get()), new AspectList().add(Aspect.MECHANISM, 2).add(Aspect.MOTION, 2));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.MIRROR_ESSENTIA.get()), new AspectList().add(Aspect.VOID, 3).add(Aspect.WATER, 2));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.MIRROR_ITEM.get()), new AspectList().add(Aspect.VOID, 3).add(Aspect.AURA, 2));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.PATTERN_CRAFTER.get()), new AspectList().add(Aspect.MECHANISM, 3).add(Aspect.TOOL, 2));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.PAVING_STONE.get()), new AspectList().add(Aspect.EARTH, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.POTION_SPRAYER.get()), new AspectList().add(Aspect.MECHANISM, 2).add(Aspect.ALCHEMY, 2));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.PRIMAL_CRUSHER.get()), new AspectList().add(Aspect.TOOL, 3).add(Aspect.ENERGY, 3).add(Aspect.METAL, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.QUARTZ_NUGGET.get()), new AspectList().add(Aspect.CRYSTAL, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.QUICKSILVER_NUGGET.get()), new AspectList().add(Aspect.METAL, 1).add(Aspect.ALCHEMY, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.RECHARGE_PEDESTAL.get()), new AspectList().add(Aspect.AURA, 3).add(Aspect.MECHANISM, 2));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.SANITY_SOAP.get()), new AspectList().add(Aspect.ALCHEMY, 2).add(Aspect.WATER, 2).add(Aspect.ORDER, 2));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.SMELTER_AUX.get()), new AspectList().add(Aspect.MECHANISM, 2));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.SMELTER_THAUMIUM.get()), new AspectList().add(Aspect.MECHANISM, 3).add(Aspect.METAL, 2));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.SMELTER_VENT.get()), new AspectList().add(Aspect.MECHANISM, 2));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.SMELTER_VOID.get()), new AspectList().add(Aspect.MECHANISM, 3).add(Aspect.VOID, 2));
        ...
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.TUBE_BUFFER.get()), new AspectList().add(Aspect.MECHANISM, 1).add(Aspect.VOID, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.VERDANT_CHARM.get()), new AspectList().add(Aspect.PLANT, 4).add(Aspect.LIFE, 3));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.VERDANT_CHARM_LIFE.get()), new AspectList().add(Aspect.LIFE, 4).add(Aspect.PLANT, 4));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.VERDANT_CHARM_SUSTAIN.get()), new AspectList().add(Aspect.PLANT, 5).add(Aspect.WATER, 3));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModItems.VOIDSEER_CHARM.get()), new AspectList().add(Aspect.SENSES, 5).add(Aspect.ELDRITCH, 3));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.TUBE_FILTER.get()), new AspectList().add(Aspect.MECHANISM, 1).add(Aspect.VOID, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.TUBE_ONEWAY.get()), new AspectList().add(Aspect.MECHANISM, 1).add(Aspect.VOID, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.TUBE_RESTRICTED.get()), new AspectList().add(Aspect.MECHANISM, 1).add(Aspect.VOID, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.TUBE_VALVE.get()), new AspectList().add(Aspect.MECHANISM, 2).add(Aspect.VOID, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.VIS_BATTERY.get()), new AspectList().add(Aspect.AURA, 3).add(Aspect.MECHANISM, 1));
        ThaumcraftApi.registerObjectTag(new ItemStack(ModBlocks.VIS_GENERATOR.get()), new AspectList().add(Aspect.AURA, 3).add(Aspect.ENERGY, 2));
