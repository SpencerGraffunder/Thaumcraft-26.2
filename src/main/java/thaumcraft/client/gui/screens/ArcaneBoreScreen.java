...
/**
 * ArcaneBoreScreen - Client-side GUI for the Arcane Bore.
 * 
 * Displays the pickaxe slot for the automated mining construct.
 */
@OnlyIn(Dist.CLIENT)
public class ArcaneBoreScreen extends AbstractContainerScreen<ArcaneBoreMenu> {
    
    private static final Identifier TEXTURE = 
            Identifier.fromNamespaceAndPath(Thaumcraft.MODID, "textures/gui/gui_arcanebore.png");
    
    public ArcaneBoreScreen(ArcaneBoreMenu menu, Inventory playerInventory, Component title) {
