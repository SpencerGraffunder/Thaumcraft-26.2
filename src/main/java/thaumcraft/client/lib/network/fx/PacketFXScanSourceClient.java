...
/** Client-side handler for {@link PacketFXScanSource}. */
public class PacketFXScanSourceClient {
    ...
    public static void handle(PacketFXScanSource msg) {
        Level level = Minecraft.getInstance().level;
        if (level == null) return;
        
        BlockPos center = BlockPos.of(msg.loc);
        startScan(level, center, msg.size);
    }
}
