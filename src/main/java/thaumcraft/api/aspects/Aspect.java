 ...
 * Aspects are the fundamental building blocks of the magic system.
 * 
 * There are 6 primal aspects and many compound aspects formed from combinations.
 * 
 * @author Azanor
 * Ported to 1.20.1
 */
public class Aspect {
    ...
    /**
     * Shortcut constructor for default aspects
     */
    ...
    /**
     * Shortcut constructor for default aspects with custom blend
     */
    ...
    /**
     * Shortcut constructor for primal aspects
     */
    ...
    public String getLocalizedDescription() {
        return Component.translatable("tc.aspect." + tag).getString();
    }
    ...
    ///////////////////////////////
    // SECONDARY ASPECTS (Primal + Primal)
    ///////////////////////////////
