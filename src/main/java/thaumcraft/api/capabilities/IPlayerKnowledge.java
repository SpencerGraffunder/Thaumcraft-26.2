 ...
 * 
 * Unless there are specific tasks you need to perform, you are better off using
 * completeResearch and addKnowledge from the IInternalMethodHandler.
 * It does most of the heavy lifting for you in regards to normal TC research.
 * These methods are purely for manipulation of the player's knowledge list
 * without any checks or crosschecks.
 * 
 * @author Azanor
 * Ported to 1.20.1
 */
public interface IPlayerKnowledge {
     ...
     * research 'example' and if it is at least at stage 2.
    ...
    /**
     * In nearly ALL circumstances IInternalMethodHandler.progressResearch or
     * IInternalMethodHandler.completeResearch should be used instead of this method.
    ...
    /**
     * In nearly ALL circumstances IInternalMethodHandler.addKnowledge
     * should be used instead of this method.
     * This simply sets the raw data without some of the other things required.
     * @param type the knowledge type
     * @param category the knowledge category key. Null value will map to empty string
     * @param amount how much raw knowledge points to add. Can be negative
     * @return if it was successfully added
     */
    boolean addKnowledge(@Nonnull EnumKnowledgeType type, String category, int amount);
    
    /**
     * @param type the knowledge type
     * @param category the knowledge category key. Null value will map to empty string
     * @return returns knowledge points divided by progression rounded down.
     * In other words, the full amount of knowledge the player has of that type.
     */
    int getKnowledge(@Nonnull EnumKnowledgeType type, String category);
     ...
     */
    int getKnowledgeRaw(@Nonnull EnumKnowledgeType type, String category);
